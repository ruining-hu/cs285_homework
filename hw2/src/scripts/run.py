...
def run_training_loop(logger, args):
    ...
    for itr in range(args.n_iter):
        ...
        trajs, envsteps_this_batch = utils.sample_trajectories(env=env, policy=agent.actor, min_timesteps_per_batch=args.batch_size, max_length=max_ep_len, render=False)
